...
cntr, u, u0, d, jm, p, fpc = fuzz.cluster.cmeans(
    r, 5, 1.05, error=0.005, maxiter=1000, init=None)
...
score = normalized_mutual_info_score(cat_list,  membership)
adjusted = adjusted_mutual_info_score(cat_list, membership)
print score
print adjusted
